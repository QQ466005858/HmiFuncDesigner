...
ModbusRtuSlaveImpl::ModbusRtuSlaveImpl()
{
...
quint16 ModbusRtuSlaveImpl::makeMessagePackage(quint8 *pSendData,
                                          void* pObj,
                                          IOTag* pTag,
...
quint16 ModbusRtuSlaveImpl::crc16(quint8 *pbuf, qint32 len)
{
...
bool ModbusRtuSlaveImpl::messageCheck(quint8 *inBuf, qint16 bufLen)
{
 ...
 */
bool ModbusRtuSlaveImpl::isCanWrite(void* pObj, IOTag* pTag)
{
    (void)pObj;
 ...
 * @return 0-失败,1-成功
 */
int ModbusRtuSlaveImpl::writeData(void* pObj, IOTag* pTag)
{
    (void)pObj;
 ...
 */
bool ModbusRtuSlaveImpl::isCanRead(void* pObj, IOTag* pTag)
{
    (void)pObj;
    Q_UNUSED(pTag)
    return true;
 ...
 * @return 0-失败,1-成功
 */
int ModbusRtuSlaveImpl::readData(void* pObj, IOTag* pTag)
{
    (void)pObj;

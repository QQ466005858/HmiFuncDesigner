...
/**
 * @brief ModbusRTU_Slave::GetRegisterAreaLimit
...
///
/// \brief ModbusRTU_Slave::getDefaultDeviceProperty
/// \details 获取设备默认属性
/// \param properties
///
...
///
/// \brief ModbusRTU_Slave::getDefaultDevicePropertyDataType
...
///
/// \brief ModbusRTU_Slave::devicePropertiesToString
/// \details 保存属性为字符串
/// \param properties 属性
/// \return 属性字符串
///
